...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "KickTime 2026 — FIFA WM-Planer für deine Zeitzone" },
      { name: "description", content: "Plane die FIFA WM 2026 nach deiner Zeitzone, deinen Teams und deinen freien Abenden – mit Live-Spielplan, Tabellen und K.-o.-Baum." },
      { name: "theme-color", content: "#0b1018" },
      { property: "og:site_name", content: "KickTime 2026" },
      { property: "og:title", content: "KickTime 2026 — FIFA WM-Planer für deine Zeitzone" },
      { name: "twitter:title", content: "KickTime 2026 — FIFA WM-Planer für deine Zeitzone" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "WebSite",
          name: "KickTime 2026",
          url: "https://kicktime-planer.lovable.app",
          description: "FIFA WM 2026 Planer: Spielplan in deiner Zeitzone, Tabellen, K.-o.-Baum, Tipprunden und Public Viewing.",
        }),
      },
      {
        type: "application/ld+json",
        children: JSON.stringify({
          ...
          name: "KickTime 2026",
          url: "https://kicktime-planer.lovable.app",
          logo: "https://kicktime-planer.lovable.app/app-icon.jpeg",
        }),
      },
    ],
  }),
